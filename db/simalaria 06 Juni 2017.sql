...
(1, 'desa1', 'P3173060202', 50000, 50000),
(2, 'desa2', 'P3173060202', 60000, 60000),
(3, 'desa3', 'P3173060202', 20000, 20000),
(4, 'desa4', 'P3173060202', 100000, 100000),
(5, 'desa5', 'P3173060202', 40000, 40000);
...
INSERT INTO `kegiatan` (`id_kegiatan`, `nama_pkm`, `bulan`, `tahun`, `jumlah_penduduk`, `suspek`, `sd_diperiksa`, `kasus_positif`, `api`, `negatif_rdt`, `negatif_mikro`, `negatif_pcr`, `skrin_pos`, `skrin_neg`, `kelambu_anc`, `kelambu_imun`, `kelambu_balita`, `kelambu_lain`) VALUES
(1, 'Kaligesing', 'Januari', 2016, 270000, 3000, NULL, 2000, 751541000, 3, 13, 2, 2, 15, 22, 25, 32, 15),
(2, 'Kaligesing', 'Februari', 2016, 500000, 3000, NULL, 5000, 10, 3, 13, 2, 2, 15, 22, 25, 32, 15);
...
(1, 'P4306120201201703001', 'dadang1', 1, 35, 1, NULL, 'desa1', NULL, NULL, '2016-01-12', '2016-01-12', '2016-01-12', '2016-01-12', 1, 1, 1, 6, 1, 1, 1, 1, 3, 3, 1, 1, 2, 3, 'P3306050201', 'Januari', 2016),
(2, 'P4306120201201703002', 'dadang2', 2, 22, 1, NULL, 'desa2', NULL, NULL, '2016-01-17', '2016-01-17', '2016-01-17', '2016-01-17', 2, 2, 2, 9, 2, 1, 2, 1, 3, 3, 2, 2, 1, 3, 'P3306050201', 'Januari', 2016),
(3, 'P4306120201201703003', 'dadang3', 3, 88, 2, NULL, 'desa3', NULL, NULL, '2016-01-10', '2016-01-10', '2016-01-10', '2016-01-10', NULL, 2, 3, 5, 2, 2, 1, 2, 3, 3, 1, 1, 2, 3, 'P3306050201', 'Januari', 2016),
(4, 'P4306120201201703004', 'dadang4', 1, 44, 1, NULL, 'desa1', NULL, NULL, '2016-01-20', '2016-01-20', '2016-01-20', '2016-01-20', 5, 2, 1, 1, 1, 2, 2, 1, 3, 3, 2, 2, 2, 3, 'P3306050201', 'Januari', 2016),
(5, 'P4306120201201703005', 'dadang5', 5, 13, 2, NULL, 'desa2', NULL, NULL, '2016-01-09', '2016-01-09', '2016-01-09', '2016-01-09', 6, 2, 4, 11, 1, 2, 1, 2, 3, 3, 1, 1, 1, 3, 'P3306050201', 'Januari', 2016);
...
CREATE TABLE IF NOT EXISTS `vektor` (
  ...
  `lintangv` float NOT NULL,
  `bujurv` float NOT NULL,
