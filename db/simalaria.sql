...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2017 at 04:55 PM
...
(3, 'Gagal Pengobatan karena Obat'),
...
(1, 'Kaligesing', 'Januari', 2017, 2000, 15, 1000, 998, 0, 1, 10, 100, 200, 300, 500),
(2, 'Dadirejo', 'Januari', 2017, 500, 20, 400, 98, 0, 0, 20, 20, 15, 2, 50),
(3, 'Kaligesing', 'Februari', 2017, 300, 100, 200, 45, 0, 0, 6, 0, 0, 0, 100),
(4, 'Pituruh', 'Februari', 2017, 10, 2, 10, 0, 0, 5, 4, 3, 2, 1, 20),
(5, 'Kemiri', 'Maret', 2017, 202, 50, 2, 200, 0, 0, 12, 0, 0, 0, 0);
...
('P3306050201', 'Januari', 1000, 200, 25000, 25, 15, 200, 10, 100),
('P3306160201', 'Januari', 1200, 50, 10, 50, 50, 20, 12, 30),
('P3306070201', 'Februari', 0, 0, 0, 0, 0, 0, 0, 0),
('P3306050201', 'Februari', 500, 60, 70, 12, 15, 40, 5, 100),
('P3306050201', 'Maret', 1000, 50, 30, 60, 10, 15, 25, 100);
...
CREATE TABLE IF NOT EXISTS `pasien` (
  ...
  `id_konf` int(1) NOT NULL,
  `id_parasit` int(1) DEFAULT NULL,
  `id_obat` int(2) DEFAULT NULL,
  `id_kondisi` int(1) NOT NULL,
  `id_rawat` int(1) NOT NULL,
  `id_fu4` int(1) NOT NULL,
  `id_fu14` int(1) NOT NULL,
  `id_fu28` int(1) NOT NULL,
  `id_fu3bl` int(1) NOT NULL,
  `id_klasifikasi` int(1) NOT NULL,
  `id_rujukdari` int(1) NOT NULL,
  `id_rujukan` int(1) NOT NULL,
  `id_pengobatan` int(1) NOT NULL,
  `id_pkm` varchar(11) NOT NULL,
  `bulan` varchar(15) NOT NULL,
  PRIMARY KEY (`no`),
...
INSERT INTO `pasien` (`no`, `id_pasien`, `nm_pasien`, `asal_keg`, `umur`, `jns_kelamin`, `dusun`, `desa`, `lintang`, `bujur`, `tgl_riwayat`, `tgl_sakit`, `tgl_kunjung`, `tgl_obat`, `pekerjaan`, `id_konf`, `id_parasit`, `id_obat`, `id_kondisi`, `id_rawat`, `id_fu4`, `id_fu14`, `id_fu28`, `id_fu3bl`, `id_klasifikasi`, `id_rujukdari`, `id_rujukan`, `id_pengobatan`, `id_pkm`, `bulan`) VALUES
(1, 'P3306050201201701001', '', 1, 14, 2, 'sumbersari', 'Kaligono', '-7.651670', '109.922931', '2017-01-07', '2017-01-10', '2017-01-10', '2017-01-10', 11, 1, 1, 5, 2, 1, 2, 2, 2, 2, 2, 2, 1, 1, 'P3306050201', 'Januari'),
(2, 'P3306050201201701001', '', 1, 73, 2, 'tumpangrejo', 'kaligono', '-8', '110', '2017-01-10', '2017-01-16', '2017-01-16', '2017-01-16', 2, 1, 1, 5, 2, 1, 2, 2, 2, 2, 1, 2, 2, 1, 'P3306050201', 'Januari'),
(3, 'P330604020201701003', '', 2, 32, 2, 'genting', 'durensari', '-8', '110', '2017-01-16', '2017-01-16', '2017-01-16', '2017-01-16', 11, 2, 1, 5, 1, 2, 2, 2, 2, 2, 1, 3, 1, 1, 'P3306040202', 'Januari'),
(4, 'P3306050201201702001', '', 1, 9, 2, 'sigayang', 'Jatirejo', '-8', '110', '2017-02-09', '2017-02-09', '2017-02-09', '2017-02-09', 11, 2, 1, 5, 1, 2, 2, 2, 2, 2, 2, 3, 2, 1, 'P3306050201', 'Februari'),
(5, 'P3306120201201703001', '', 2, 45, 2, 'karanganyar', 'kedungpomahan wetan', '-8', '110', '2017-03-11', '2017-03-11', '2017-03-11', '2017-03-11', 7, 1, 1, 5, 2, 2, 1, 2, 2, 2, 2, 3, 2, 1, 'P3306120201', 'Maret');
...
(1, '', '', 'ffffffffffff'),
(2, '-7.650084', '109.920345', 'V'),
(3, '-7.650722', '109.917555', 'P'),
(4, '-7.654327', '109.913220', 'P'),
(5, '-7.659783', '109.922587', 'V');
...
CREATE TABLE IF NOT EXISTS `vektor` (
  ...
  `lintangv` varchar(15) NOT NULL,
  `bujurv` varchar(15) NOT NULL,
  `luas_tp` int(15) NOT NULL,
  `jenis_kendali` text NOT NULL,
  `kategori` text NOT NULL,
  KEY `id_pkm` (`id_pkm`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('P3306050201', 'Januari', 'Sungai', '-7.650084', '109.920345', 0, 'larvasida', 'V'),
('P3306120202', 'Februari', 'Kolam', '-7.650084', '109.920365', 10000, 'Tabur Ikan', 'V');
...
--
ALTER TABLE `desa`
  ADD CONSTRAINT `desa_ibfk_1` FOREIGN KEY (`id_pkm`) REFERENCES `puskemas` (`id_pkm`);

--
-- Constraints for table `logistik`
--
ALTER TABLE `logistik`
  ADD CONSTRAINT `logistik_ibfk_1` FOREIGN KEY (`id_pkm`) REFERENCES `puskemas` (`id_pkm`);

--
-- Constraints for table `pasien`
--
ALTER TABLE `pasien`
  ADD CONSTRAINT `pasien_ibfk_1` FOREIGN KEY (`asal_keg`) REFERENCES `asal_keg` (`asal_keg`),
  ADD CONSTRAINT `pasien_ibfk_10` FOREIGN KEY (`id_fu14`) REFERENCES `fu14` (`id_fu14`),
  ADD CONSTRAINT `pasien_ibfk_11` FOREIGN KEY (`id_fu28`) REFERENCES `fu28` (`id_fu28`),
  ADD CONSTRAINT `pasien_ibfk_12` FOREIGN KEY (`id_fu3bl`) REFERENCES `fu3bl` (`id_fu3bl`),
  ADD CONSTRAINT `pasien_ibfk_13` FOREIGN KEY (`id_rujukdari`) REFERENCES `rujuk_dari` (`id_rujukdari`),
  ADD CONSTRAINT `pasien_ibfk_14` FOREIGN KEY (`id_rujukan`) REFERENCES `rujuk_ke` (`id_rujukan`),
  ADD CONSTRAINT `pasien_ibfk_15` FOREIGN KEY (`id_pengobatan`) REFERENCES `hasil_obat` (`id_pengobatan`),
  ADD CONSTRAINT `pasien_ibfk_16` FOREIGN KEY (`id_pkm`) REFERENCES `puskemas` (`id_pkm`),
  ADD CONSTRAINT `pasien_ibfk_17` FOREIGN KEY (`id_klasifikasi`) REFERENCES `klasifikasi` (`id_klasifikasi`),
  ADD CONSTRAINT `pasien_ibfk_2` FOREIGN KEY (`jns_kelamin`) REFERENCES `jenis_kelamin` (`jns_kelamin`),
  ADD CONSTRAINT `pasien_ibfk_3` FOREIGN KEY (`pekerjaan`) REFERENCES `kerja` (`id_kerja`),
  ADD CONSTRAINT `pasien_ibfk_4` FOREIGN KEY (`id_konf`) REFERENCES `konfirmasi` (`id_konf`),
  ADD CONSTRAINT `pasien_ibfk_5` FOREIGN KEY (`id_parasit`) REFERENCES `parasit` (`id_parasit`),
  ADD CONSTRAINT `pasien_ibfk_6` FOREIGN KEY (`id_obat`) REFERENCES `obat` (`id_obat`),
  ADD CONSTRAINT `pasien_ibfk_7` FOREIGN KEY (`id_kondisi`) REFERENCES `kondisi` (`id_kondisi`),
  ADD CONSTRAINT `pasien_ibfk_8` FOREIGN KEY (`id_rawat`) REFERENCES `perawatan` (`id_rawat`),
  ADD CONSTRAINT `pasien_ibfk_9` FOREIGN KEY (`id_fu4`) REFERENCES `fu4` (`id_fu4`);
...
--
-- Constraints for table `vektor`
--
ALTER TABLE `vektor`
  ADD CONSTRAINT `vektor_ibfk_1` FOREIGN KEY (`id_pkm`) REFERENCES `puskemas` (`id_pkm`);
