			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-footer clearfix">
						<?php  echo anchor('pemetaan/export/','Unduh Koordinat', array('class' => 'btn btn-primary btn-sm btn-flat pull-left')) ?>
						<div></div>
						<?php  echo anchor('pemetaan/pdf/','Unduh PDF', array('class' => 'btn btn-primary btn-sm btn-flat pull-left')) ?>
						<!-- pagination start -->
